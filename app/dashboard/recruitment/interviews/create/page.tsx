...
export default function CreateInterviewPage() {
  ...
  const handleInterviewerChange = (index: number, field: string, value: string) => {
    ...
    updatedInterviewers[index] = { ...updatedInterviewers[index], [field]: value }
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-4">
                {interviewers.map((interviewer, index) => (
                  <div key={index} className="grid gap-4 md:grid-cols-2 p-4 border rounded-md">
                    <div className="space-y-2">
                ...
                <Button type="button" variant="outline" onClick={addInterviewer} className="w-full border-dashed">
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="interviewDate" className="text-xs text-muted-foreground">
                    Ngày phỏng vấn
                  </Label>
                  <Popover>
                ...
                <div className="space-y-2">
                  <Label htmlFor="interviewTime" className="text-xs text-muted-foreground">
                    Thời gian
                  </Label>
                  <Select>
                    <SelectTrigger>
                    ...
                    <SelectContent>
                      {Array.from({ length: 19 }, (_, i) => i + 8).map((hour) => (
          ...
          <CardFooter className="flex justify-between">
            <Button
              variant="outline"
              type="button"
              onClick={() => router.push("/dashboard/recruitment?tab=interviews")}
            >
              Quay lại
            </Button>
